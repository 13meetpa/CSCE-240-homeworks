...
// output parameter.
//
// Searches the sub-columns and sub-rows of the
// matrix for a sequence of integers which sum to the value provided.  Note
// that row indices must be in the direction of increasing column
...
const size_t kMatrix_size_rows_idx = 0;
const size_t kMatrix_size_cols_idx = 1;

const size_t kIndices_size = 4;
const size_t kIndices_start_row_idx = 0;
const size_t kIndices_start_col_idx = 1;
const size_t kIndices_end_row_idx = 2;
const size_t kIndices_end_col_idx = 3;
