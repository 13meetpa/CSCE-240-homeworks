#ifndef TEST_FIND_SUM_H_
#define TEST_FIND_SUM_H_


#include "find_sum.h"  // test file interface
#include "find_sum.h"  // idempotency test (do not remove)
